import { Devvit, useWebView, useState, useForm } from '@devvit/public-api';
...
const App: Devvit.BlockComponent = (context) => {
  ...
  // Store webView reference to access it in form handler
  let webViewRef: { current: any } = { current: null };
